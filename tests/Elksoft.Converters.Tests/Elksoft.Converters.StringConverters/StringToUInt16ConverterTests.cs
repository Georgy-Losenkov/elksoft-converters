...
{
    public sealed class StringToUInt16ConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new StringToUInt16Converter();
        ...
        {
            var converter = new StringToUInt16Converter();
            converter.Convert(input, provider).Should().Be(UInt16.Parse(input, provider));
        }
