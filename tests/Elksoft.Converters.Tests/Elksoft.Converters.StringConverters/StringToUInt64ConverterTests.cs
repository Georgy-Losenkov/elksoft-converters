...
{
    public sealed class StringToUInt64ConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new StringToUInt64Converter();
        ...
        {
            var converter = new StringToUInt64Converter();
            converter.Convert(input, provider).Should().Be(UInt64.Parse(input, provider));
        }
