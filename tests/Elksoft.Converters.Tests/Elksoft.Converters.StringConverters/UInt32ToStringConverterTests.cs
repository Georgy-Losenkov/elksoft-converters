...
{
    public sealed class UInt32ToStringConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new UInt32ToStringConverter();
        ...
        public static TheoryData<UInt32, IFormatProvider> Convert_ReturnsExpected_Data()
        {
            ...
            return new TheoryData<UInt32, IFormatProvider>() {
        ...
        public static void Convert_ReturnsExpected(UInt32 input, IFormatProvider provider)
        {
            var converter = new UInt32ToStringConverter();
