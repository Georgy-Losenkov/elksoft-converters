...
{
    public sealed class StringToInt64ConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new StringToInt64Converter();
        ...
        {
            var converter = new StringToInt64Converter();
            converter.Convert(input, provider).Should().Be(Int64.Parse(input, provider));
        }
