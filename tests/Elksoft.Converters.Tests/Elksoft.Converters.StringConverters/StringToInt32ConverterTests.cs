...
{
    public sealed class StringToInt32ConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new StringToInt32Converter();
        ...
        {
            var converter = new StringToInt32Converter();
            converter.Convert(input, provider).Should().Be(Int32.Parse(input, provider));
        }
