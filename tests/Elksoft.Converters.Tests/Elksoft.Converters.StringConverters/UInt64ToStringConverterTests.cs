...
{
    public sealed class UInt64ToStringConverterTests
    {
        [Fact]
        public static void AcceptsNull_ReturnsFalse()
        {
            var converter = new UInt64ToStringConverter();
        ...
        public static TheoryData<UInt64, IFormatProvider> Convert_ReturnsExpected_Data()
        {
            ...
            return new TheoryData<UInt64, IFormatProvider>() {
        ...
        public static void Convert_ReturnsExpected(UInt64 input, IFormatProvider provider)
        {
            var converter = new UInt64ToStringConverter();
