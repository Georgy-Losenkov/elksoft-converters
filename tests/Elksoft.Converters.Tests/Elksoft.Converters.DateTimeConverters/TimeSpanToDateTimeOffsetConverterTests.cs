...
{
    public sealed class TimeSpanToDateTimeOffsetConverterTests
    {
        [Fact]
        public static void AcceptsNull_IsFalse()
        {
            var converter = new TimeSpanToDateTimeOffsetConverter();
        ...
        public static void Convert_ReturnsExpected(TimeSpan input)
        {
            ...
            var converter = new TimeSpanToDateTimeOffsetConverter();
            converter.Convert(input, null).Should().Be(DateTimeOffset.MinValue.Add(input));
            converter.Convert(input, mockProvider.Object).Should().Be(DateTimeOffset.MinValue.Add(input));
