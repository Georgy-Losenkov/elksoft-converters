...
using ConverterClass = Elksoft.Converters.Converter<System.Object, System.Object>;
using WrapperClass = Elksoft.Converters.Transformers.RejectingNullWrapperCCCC<System.Object, System.Object>;

namespace Elksoft.Converters.Transformers
{
    public class RejectingNullWrapperCCCCTests
    {
        [Fact]
        ...
        internal void Convert_InvokeOnNullInput_ReturnsExpected()
        {
            ...
            var instance = new WrapperClass(mockInnerConverter.Object);
            instance.Convert(null, null).Should().Be(default(Object));
            instance.Convert(null, mockProvider.Object).Should().Be(default(Object));
