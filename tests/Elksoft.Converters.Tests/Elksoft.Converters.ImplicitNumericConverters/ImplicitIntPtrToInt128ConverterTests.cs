...
{
    public class ImplicitIntPtrToInt128ConverterTests
    {
        [Fact]
        public static void AcceptsNull_IsFalse()
        {
            var converter = new ImplicitIntPtrToInt128Converter();
        ...
        public static TheoryData<IntPtr, Int128> Convert_ReturnsExpected_Data()
        {
            if (IntPtr.Size == 4)
            {
                return new TheoryData<IntPtr, Int128>() {
                    { new IntPtr(Int32.MinValue), Int32.MinValue },
                    { new IntPtr(Int16.MinValue), Int16.MinValue },
                    { new IntPtr(SByte.MinValue), SByte.MinValue },
                    { new IntPtr(-1), -1 },
                    { IntPtr.Zero, Int128.Zero },
                    { new IntPtr(1), Int128.One },
        ...
        public static void Convert_ReturnsExpected(IntPtr input, Int128 output)
        {
