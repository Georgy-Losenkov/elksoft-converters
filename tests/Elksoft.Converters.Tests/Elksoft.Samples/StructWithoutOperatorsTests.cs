...
{
    public class StructWithoutOperatorsTests
    {
        #region 0 parameters
        [Fact]
        public static void Method000_ThrowsNotImplementedException()
        {
            var instance = new StructWithoutOperators();
        ...
        {
            new Action(() => StructWithoutOperators.Method100()).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method101_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method101()).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method102_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method102()).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method110_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method110<Byte>()).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method111_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method111<Byte>()).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method112_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method112<Byte>()).Should().ThrowExactly<NotImplementedException>();
        }
        #endregion
        ...
        {
            new Action(() => StructWithoutOperators.Method1000(out _)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1010_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1010(out _)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1020_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1020(out _)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1100_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1100<Byte>(out _)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1110_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1110<Byte>(out _)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1120_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1120<Byte>(out _)).Should().ThrowExactly<NotImplementedException>();
        }
        #endregion
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1001(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1011(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1021(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1101<Byte>(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1111<Byte>(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        ...
        {
            Byte value = 1;
            new Action(() => StructWithoutOperators.Method1121<Byte>(ref value)).Should().ThrowExactly<NotImplementedException>();
        }
        #endregion
        ...
        {
            new Action(() => StructWithoutOperators.Method1002(1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1012_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1012(1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1022_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1022(1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1102_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1102<Byte>(1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1112_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1112<Byte>(1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method1122_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method1122<Byte>(1)).Should().ThrowExactly<NotImplementedException>();
        }
        #endregion
        ...
        {
            new Action(() => StructWithoutOperators.Method10022(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method10122_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method10122(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method10222_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method10222(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method11022_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method11022<Byte>(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method11122_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method11122<Byte>(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }

        [Fact]
        public static void Method11222_ThrowsNotImplementedException()
        {
            new Action(() => StructWithoutOperators.Method11222<Byte>(1, 1)).Should().ThrowExactly<NotImplementedException>();
        }
        #endregion
    }
}