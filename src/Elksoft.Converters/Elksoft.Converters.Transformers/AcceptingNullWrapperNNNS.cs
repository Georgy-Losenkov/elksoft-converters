// <copyright file="AcceptingNullWrapperNNNS.cs" company="Georgy Losenkov">
...
{
    internal sealed class AcceptingNullWrapperNNNS<TIn, TOut> : Converter<TIn?, TOut>
        where TIn : struct
        where TOut : struct
    {
        public AcceptingNullWrapperNNNS(Converter<TIn?, TOut?> innerConverter)
        {
