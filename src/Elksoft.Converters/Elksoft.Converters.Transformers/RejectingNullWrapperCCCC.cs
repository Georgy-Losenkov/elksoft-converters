// <copyright file="RejectingNullWrapperCCCC.cs" company="Georgy Losenkov">
...
{
    internal sealed class RejectingNullWrapperCCCC<TIn, TOut> : Converter<TIn, TOut>
        where TIn : class
        where TOut : class
    {
        public RejectingNullWrapperCCCC(Converter<TIn, TOut> innerConverter)
        {
