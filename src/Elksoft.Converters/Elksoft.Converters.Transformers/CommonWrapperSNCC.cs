// <copyright file="CommonWrapperSNCC.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSNCC<TIn, TOut> : Converter<TIn, TOut>
        where TIn : struct
        where TOut : class
    {
        public CommonWrapperSNCC(Converter<TIn?, TOut> innerConverter)
        {
