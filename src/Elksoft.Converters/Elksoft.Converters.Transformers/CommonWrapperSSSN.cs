// <copyright file="CommonWrapperSSSN.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSSSN<TIn, TOut> : Converter<TIn, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSSSN(Converter<TIn, TOut> innerConverter)
        {
