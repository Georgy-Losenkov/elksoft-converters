// <copyright file="CommonWrapperSNNN.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSNNN<TIn, TOut> : Converter<TIn, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSNNN(Converter<TIn?, TOut?> innerConverter)
        {
