// <copyright file="CommonWrapperSSNS.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSSNS<TIn, TOut> : Converter<TIn, TOut>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSSNS(Converter<TIn, TOut?> innerConverter)
        {
