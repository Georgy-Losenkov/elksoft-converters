// <copyright file="AcceptingNullWrapperNNSN.cs" company="Georgy Losenkov">
...
{
    internal sealed class AcceptingNullWrapperNNSN<TIn, TOut> : Converter<TIn?, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public AcceptingNullWrapperNNSN(Converter<TIn?, TOut> innerConverter)
        {
