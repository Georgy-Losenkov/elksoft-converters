// <copyright file="CommonWrapperSNSS.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSNSS<TIn, TOut> : Converter<TIn, TOut>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSNSS(Converter<TIn?, TOut> innerConverter)
        {
