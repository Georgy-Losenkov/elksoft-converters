// <copyright file="RejectingNullWrapperNNSS.cs" company="Georgy Losenkov">
...
{
    internal sealed class RejectingNullWrapperNNSS<TIn, TOut> : Converter<TIn?, TOut>
        where TIn : struct
        where TOut : struct
    {
        public RejectingNullWrapperNNSS(Converter<TIn?, TOut> innerConverter)
        {
