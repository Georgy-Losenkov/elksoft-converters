// <copyright file="RejectingNullWrapperCCNN.cs" company="Georgy Losenkov">
...
{
    internal sealed class RejectingNullWrapperCCNN<TIn, TOut> : Converter<TIn, TOut?>
        where TIn : class
        where TOut : struct
    {
        public RejectingNullWrapperCCNN(Converter<TIn, TOut?> innerConverter)
        {
