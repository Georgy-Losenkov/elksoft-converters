// <copyright file="CommonWrapperSNNS.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSNNS<TIn, TOut> : Converter<TIn, TOut>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSNNS(Converter<TIn?, TOut?> innerConverter)
        {
