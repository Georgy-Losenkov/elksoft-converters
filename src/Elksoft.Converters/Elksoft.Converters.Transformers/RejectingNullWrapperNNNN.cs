// <copyright file="RejectingNullWrapperNNNN.cs" company="Georgy Losenkov">
...
{
    internal sealed class RejectingNullWrapperNNNN<TIn, TOut> : Converter<TIn?, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public RejectingNullWrapperNNNN(Converter<TIn?, TOut?> innerConverter)
        {
