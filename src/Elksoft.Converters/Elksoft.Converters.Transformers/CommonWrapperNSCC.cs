// <copyright file="CommonWrapperNSCC.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperNSCC<TIn, TOut> : Converter<TIn?, TOut>
        where TIn : struct
        where TOut : class
    {
        public CommonWrapperNSCC(Converter<TIn, TOut> innerConverter)
        {
