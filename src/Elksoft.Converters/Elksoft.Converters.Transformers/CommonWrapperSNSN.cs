// <copyright file="CommonWrapperSNSN.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperSNSN<TIn, TOut> : Converter<TIn, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperSNSN(Converter<TIn?, TOut> innerConverter)
        {
