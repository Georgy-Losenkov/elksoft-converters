// <copyright file="CommonWrapperNSNN.cs" company="Georgy Losenkov">
...
{
    internal sealed class CommonWrapperNSNN<TIn, TOut> : Converter<TIn?, TOut?>
        where TIn : struct
        where TOut : struct
    {
        public CommonWrapperNSNN(Converter<TIn, TOut?> innerConverter)
        {
